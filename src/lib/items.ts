...
// pane. The split into two records on save lives in `saveItemRow`. Rarity, item
// tags, and biome choices come from the Registry (see src/lib/registry).
export const ITEM_FIELDS: EntityField<ItemRow>[] = [
  ...
  { key: "rarity", label: "Rarity", kind: "select", optionsFrom: "rarities" },
  ...
  { key: "itemTags", label: "Item Tags", kind: "tags", optionsFrom: "itemTags", full: true },
  { key: "biomes", label: "Biomes", kind: "tags", optionsFrom: "biomes", full: true },
];
